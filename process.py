...
def parse_args():
    ...
    parser.add_argument('-t', '--threshold-blur', type=float, default=2, help='blurry threshold')
    parser.add_argument('-b', '--threshold-bright', type=float, default=1, help='bright threshold')
